...
class Identity_Injection_Module(nn.Module):
    def __init__(self, output_dim, z_id_size=512):
        super(Identity_Injection_Module, self).__init__()
...
class Operation_Unit(nn.Module):
    def __init__(self, channel, identity_feature_out_dim,identity_feature_in_dim=512,act_out=True):
        ...
        self.IIM = Identity_Injection_Module(self.id_feature_out_dim,z_id_size=self.id_feature_in_dim)

    def forward(self, input_feature, id_feature):
        idf0_0, idf0_1 = self.IIM(id_feature)
...
class Swapped_Face_Generator(nn.Module):
    def __init__(self, in_channels=1023, out_channels=3):
        super(Swapped_Face_Generator, self).__init__()
...
class ResBlk(nn.Module):
    def __init__(self, dim_in, dim_out, actv=nn.LeakyReLU(0.2),
                 normalise=False, downsample=False):
        super().__init__()
        self.actv = actv
...
if __name__ == '__main__':
    #Test 'Open!' Encoder
    Encoder = Fusion_Encoder(512)
    Generator = Swapped_Face_Generator(1024,3)
